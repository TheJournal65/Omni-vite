...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // Default category filter initialized to user's preferences
  const [selectedCategories, setSelectedCategories] = useState<EventCategory[]>(user.favoriteCategories);
