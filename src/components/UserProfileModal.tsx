        ...
        <div className="px-6 py-4 border-b border-slate-800 flex items-center justify-between bg-slate-800/50">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Personalize your campus event radar</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSave} className="p-6 space-y-4 max-h-[75vh] overflow-y-auto">
          ...
          <div className="space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-800 border border-slate-700 rounded-xl px-3.5 py-2.5 text-sm text-white focus:outline-none focus:ring-2 focus:ring-emerald-500/50"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className={`w-full bg-slate-800 border rounded-xl px-3.5 py-2.5 text-sm text-white focus:outline-none focus:ring-2 ${
                  emailError
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-slate-800 border border-slate-700 rounded-xl p-3 text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 resize-none"
            />
          ...
          <div className="pt-4 border-t border-slate-800 flex items-center justify-end gap-3">
            ...
            <button
              type="submit"
              className="px-5 py-2.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-slate-950 text-sm font-extrabold shadow-lg shadow-emerald-950/50 transition-all active:scale-95 flex items-center gap-1.5"
            >
